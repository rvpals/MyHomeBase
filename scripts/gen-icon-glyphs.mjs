...
// The 15 module concepts (matches ModuleIconName in src/lib/modules).
const CONCEPTS = ["building", "home", "briefcase", "wallet", "chart", "folder", "shield", "heart", "book", "tool", "journal", "roster", "music", "game", "photo"];
...
function kw(c) {
  return {
    ...
    photo: ["photo", "image", "picture", "camera", "gallery"],
  }[c];
}

const CAND = {
  lucide: { building: ["building-2"], home: ["house", "home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["bar-chart-3", "chart-column"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book-open"], tool: ["wrench"], journal: ["notebook-pen"], roster: ["clipboard-list"], music: ["music", "music-4"], game: ["gamepad-2", "gamepad"], photo: ["image"], magic: ["wand-sparkles", "wand"], player: ["turntable", "disc-3"] },
  ...
  tabler: { building: ["building"], home: ["home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["chart-bar"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book"], tool: ["tools"], journal: ["notebook"], roster: ["checklist"], music: ["music"], game: ["device-gamepad-2", "device-gamepad"], photo: ["photo"], magic: ["wand"], player: ["vinyl", "disc"] },
  // Material Symbols' unsuffixed names are the filled variants ("-outline" is the
  // outline), which is the point of adding this set.
  ms: { building: ["apartment"], home: ["home"], briefcase: ["work", "business-center"], wallet: ["wallet"], chart: ["bar-chart"], folder: ["folder"], shield: ["shield"], heart: ["favorite"], book: ["book-2"], tool: ["build", "handyman"], journal: ["history-edu"], roster: ["checklist"], music: ["music-note", "library-music"], game: ["sports-esports", "videogame-asset"], photo: ["photo", "image"] },
  mingcute: { building: ["building-2-fill"], home: ["home-3-fill"], briefcase: ["briefcase-fill"], wallet: ["wallet-fill"], chart: ["chart-bar-fill"], folder: ["folder-fill"], shield: ["shield-fill"], heart: ["heart-fill"], book: ["book-2-fill"], tool: ["tool-fill"], journal: ["book-4-fill", "book-2-fill"], roster: ["task-2-fill"], music: ["music-2-fill", "music-fill"], game: ["game-2-fill", "game-1-fill"], photo: ["pic-fill", "photo-album-fill"], magic: ["magic-hat-fill", "magic-1-fill"], player: ["disc-fill", "album-fill"] },
  ph: (c) => [`${{ building: "buildings", home: "house", briefcase: "briefcase", wallet: "wallet", chart: "chart-bar", folder: "folder", shield: "shield-check", heart: "heart", book: "book-open", tool: "wrench", journal: "notebook", roster: "list-checks", music: "music-notes", game: "game-controller", photo: "image" }[c]}-duotone`],
  solarLine: (c) => ({ building: ["buildings-2-line-duotone"], home: ["home-2-line-duotone", "home-line-duotone"], briefcase: ["case-line-duotone"], wallet: ["wallet-line-duotone"], chart: ["chart-2-line-duotone"], folder: ["folder-line-duotone"], shield: ["shield-check-line-duotone"], heart: ["heart-line-duotone"], book: ["book-2-line-duotone", "book-line-duotone"], tool: ["settings-line-duotone", "wrench-line-duotone"], journal: ["notebook-bookmark-line-duotone", "notebook-line-duotone"], roster: ["checklist-line-duotone"], music: ["music-notes-line-duotone", "music-note-2-line-duotone"], game: ["gamepad-line-duotone", "gamepad-minimalistic-line-duotone"], photo: ["gallery-line-duotone", "album-line-duotone"] }[c]),
  solarBold: (c) => ({ building: ["buildings-2-bold-duotone"], home: ["home-2-bold-duotone", "home-bold-duotone"], briefcase: ["case-bold-duotone"], wallet: ["wallet-bold-duotone"], chart: ["chart-2-bold-duotone"], folder: ["folder-bold-duotone"], shield: ["shield-check-bold-duotone"], heart: ["heart-bold-duotone"], book: ["book-2-bold-duotone", "book-bold-duotone"], tool: ["settings-bold-duotone", "wrench-bold-duotone"], journal: ["notebook-bookmark-bold-duotone", "notebook-bold-duotone"], roster: ["checklist-bold-duotone"], music: ["music-notes-bold-duotone", "music-note-2-bold-duotone"], game: ["gamepad-bold-duotone", "gamepad-minimalistic-bold-duotone"], photo: ["gallery-bold-duotone", "album-bold-duotone"] }[c]),
  hugeicons: { building: ["building-03", "building-06"], home: ["home-01", "home-04"], briefcase: ["briefcase-01"], wallet: ["wallet-01", "wallet-02"], chart: ["analytics-01", "chart-histogram"], folder: ["folder-01"], shield: ["shield-01"], heart: ["favourite-square", "favourite"], book: ["book-01", "notebook-01"], tool: ["wrench-01", "tools"], journal: ["notebook-02", "notebook-01"], roster: ["check-list"], music: ["music-note-01", "music-note-02"], game: ["game-controller-01", "gamepad"], photo: ["image-02", "image-01"], magic: ["magic-wand-01", "magic-wand-02"], player: ["disc-3", "record"] },
  streamlineColor: { building: ["building-2"], home: ["home-4", "home-3"], briefcase: ["briefcase-dollar", "briefcase"], wallet: ["wallet", "money-wallet"], chart: ["graph-bar-increase"], folder: ["folder-check", "folder-add"], shield: ["shield-check", "shield-1"], heart: ["heart", "love-it"], book: ["book-reading", "book-1", "read-1"], tool: ["tools-wench-screwdriver", "wench-1", "settings-slider"], journal: ["book-reading"], roster: ["task-list"], music: ["music-note-2", "music-note-1"], game: ["controller", "controller-1"], photo: ["picture-landscape", "image-picture"] },
  fc: { building: ["org-unit", "home"], home: ["home"], briefcase: ["business", "portfolio"], wallet: ["money", "currency-exchange"], chart: ["bar-chart", "combo-chart"], folder: ["folder"], shield: ["security-checked", "privacy"], heart: ["like", "add-to-favorites"], book: ["reading", "library"], tool: ["engineering", "services", "support"], journal: ["reading-ebook", "address-book"], roster: ["todo-list"], music: ["music"], game: ["puzzle"], photo: ["picture", "gallery"] },
  fluentFlat: { building: ["office-building", "building-construction"], home: ["house", "house-with-garden"], briefcase: ["briefcase"], wallet: ["money-bag", "credit-card"], chart: ["bar-chart", "chart-increasing"], folder: ["file-folder", "open-file-folder"], shield: ["shield"], heart: ["red-heart", "sparkling-heart"], book: ["open-book", "books", "book"], tool: ["hammer-and-wrench", "wrench", "toolbox"], journal: ["notebook-with-decorative-cover"], roster: ["clipboard"], music: ["musical-notes", "musical-note"], game: ["video-game", "joystick"], photo: ["framed-picture", "camera"] },
...
--------------------------------------------------------------------------------------- */
const TREE_CONCEPTS = [
  "grid", "list", "history", "database", "csv-file", "stock-quote", "chart", "upload", "sliders", "gear",
...
function treeKw(c) {
  return {
    ...
    database: ["database", "server"], "csv-file": ["csv", "file-spreadsheet", "table", "spreadsheet"],
    "stock-quote": ["stock", "trend", "chart-line", "graph"],
...
const TREE_CAND = {
  lucide: { grid: ["layout-grid"], list: ["list"], history: ["history"], database: ["database"], "csv-file": ["file-spreadsheet"], "stock-quote": ["trending-up"], chart: ["bar-chart-3", "chart-column"], upload: ["upload"], sliders: ["sliders-horizontal"], gear: ["settings"], classroom: ["presentation"], users: ["users"], newspaper: ["newspaper"], plus: ["plus"], quote: ["quote"], window: ["app-window"], palette: ["palette"], info: ["info"], shapes: ["shapes"], note: ["sticky-note"], clip: ["paperclip"], shield: ["shield-check"] },
  tabler: { grid: ["layout-grid"], list: ["list"], history: ["history"], database: ["database"], "csv-file": ["file-type-csv", "file-spreadsheet"], "stock-quote": ["trending-up"], chart: ["chart-bar"], upload: ["upload"], sliders: ["adjustments-horizontal"], gear: ["settings"], classroom: ["presentation"], users: ["users"], newspaper: ["news"], plus: ["plus"], quote: ["quote"], window: ["app-window"], palette: ["palette"], info: ["info-circle"], shapes: ["shape"], note: ["note"], clip: ["paperclip"], shield: ["shield-check"] },
  "material-symbols": { grid: ["grid-view"], list: ["list"], history: ["history"], database: ["database"], "csv-file": ["csv", "table-view"], "stock-quote": ["trending-up"], chart: ["bar-chart"], upload: ["upload"], sliders: ["tune"], gear: ["settings"], classroom: ["co-present"], users: ["group"], newspaper: ["newspaper"], plus: ["add"], quote: ["format-quote"], window: ["web-asset"], palette: ["palette"], info: ["info"], shapes: ["shapes"], note: ["sticky-note-2"], clip: ["attach-file"], shield: ["shield"], magic: ["wand-stars", "auto-awesome"], player: ["album", "radio"] },
  ...
  "flat-color": { grid: ["grid"], list: ["todo-list"], history: ["clock"], database: ["data-sheet"], "csv-file": ["xls", "document"], "stock-quote": ["line-chart", "positive-dynamic"], chart: ["bar-chart"], upload: ["upload"], sliders: ["data-configuration"], gear: ["settings"], classroom: ["voice-presentation"], users: ["conference-call"], newspaper: ["news"], plus: ["plus"], quote: ["comments"], window: ["template"], palette: ["picture"], info: ["about"], shapes: ["tree-structure"], note: ["survey"], clip: [], shield: ["privacy"], magic: ["idea"], player: ["music", "audio-file"] },
  ...
  "fluent-flat": { grid: ["card-index-dividers"], list: ["clipboard"], history: ["watch", "stopwatch"], database: ["file-cabinet", "card-file-box"], "csv-file": ["page-facing-up", "spiral-notepad"], "stock-quote": ["chart-increasing"], chart: ["bar-chart"], upload: ["outbox-tray"], sliders: ["control-knobs"], gear: ["gear"], classroom: ["teacher"], users: ["busts-in-silhouette"], newspaper: ["newspaper"], plus: ["plus"], quote: ["left-speech-bubble"], window: ["window"], palette: ["artist-palette"], info: ["information"], shapes: ["puzzle-piece"], note: ["memo"], clip: ["paperclip"], shield: ["shield"], magic: ["magic-wand", "top-hat"], player: ["optical-disk", "studio-microphone"] },
  "fluent-3d": { grid: ["card-index-dividers"], list: ["clipboard"], history: ["watch", "stopwatch"], database: ["file-cabinet", "card-file-box"], "csv-file": ["page-facing-up", "spiral-notepad"], "stock-quote": ["chart-increasing"], chart: ["bar-chart"], upload: ["outbox-tray"], sliders: ["control-knobs"], gear: ["gear"], classroom: ["teacher"], users: ["busts-in-silhouette"], newspaper: ["newspaper"], plus: ["plus"], quote: ["left-speech-bubble"], window: ["window"], palette: ["artist-palette"], info: ["information"], shapes: ["puzzle-piece"], note: ["memo"], clip: ["paperclip"], shield: ["shield"], magic: ["magic-wand", "top-hat"], player: ["optical-disk", "studio-microphone"] },
};
