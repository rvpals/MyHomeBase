...
const CAND = {
  lucide: { building: ["building-2"], home: ["house", "home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["bar-chart-3", "chart-column"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book-open"], tool: ["wrench"], journal: ["notebook-pen"], roster: ["clipboard-list"], music: ["music", "music-4"], magic: ["wand-sparkles", "wand"], player: ["turntable", "disc-3"] },
  ...
  tabler: { building: ["building"], home: ["home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["chart-bar"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book"], tool: ["tools"], journal: ["notebook"], roster: ["checklist"], music: ["music"], magic: ["wand"], player: ["vinyl", "disc"] },
  ...
  hugeicons: { building: ["building-03", "building-06"], home: ["home-01", "home-04"], briefcase: ["briefcase-01"], wallet: ["wallet-01", "wallet-02"], chart: ["analytics-01", "chart-histogram"], folder: ["folder-01"], shield: ["shield-01"], heart: ["favourite-square", "favourite"], book: ["book-01", "notebook-01"], tool: ["wrench-01", "tools"], journal: ["notebook-02", "notebook-01"], roster: ["check-list"], music: ["music-note-01", "music-note-02"], magic: ["magic-wand-01", "magic-wand-02"], player: ["disc-3", "record"] },
