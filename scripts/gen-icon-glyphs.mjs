...
// The 13 module concepts (matches ModuleIconName in src/lib/modules).
const CONCEPTS = ["building", "home", "briefcase", "wallet", "chart", "folder", "shield", "heart", "book", "tool", "journal", "roster", "music"];
...
const CAND = {
  lucide: { building: ["building-2"], home: ["house", "home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["bar-chart-3", "chart-column"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book-open"], tool: ["wrench"], journal: ["notebook-pen"], roster: ["clipboard-list"], music: ["music", "music-4"] },
  ...
  tabler: { building: ["building"], home: ["home"], briefcase: ["briefcase"], wallet: ["wallet"], chart: ["chart-bar"], folder: ["folder"], shield: ["shield-check"], heart: ["heart"], book: ["book"], tool: ["tools"], journal: ["notebook"], roster: ["checklist"], music: ["music"] },
  // Material Symbols' unsuffixed names are the filled variants ("-outline" is the
  // outline), which is the point of adding this set.
  ms: { building: ["apartment"], home: ["home"], briefcase: ["work", "business-center"], wallet: ["wallet"], chart: ["bar-chart"], folder: ["folder"], shield: ["shield"], heart: ["favorite"], book: ["book-2"], tool: ["build", "handyman"], journal: ["history-edu"], roster: ["checklist"], music: ["music-note", "library-music"] },
  mingcute: { building: ["building-2-fill"], home: ["home-3-fill"], briefcase: ["briefcase-fill"], wallet: ["wallet-fill"], chart: ["chart-bar-fill"], folder: ["folder-fill"], shield: ["shield-fill"], heart: ["heart-fill"], book: ["book-2-fill"], tool: ["tool-fill"], journal: ["book-4-fill", "book-2-fill"], roster: ["task-2-fill"], music: ["music-2-fill", "music-fill"] },
  ph: (c) => [`${{ building: "buildings", home: "house", briefcase: "briefcase", wallet: "wallet", chart: "chart-bar", folder: "folder", shield: "shield-check", heart: "heart", book: "book-open", tool: "wrench", journal: "notebook", roster: "list-checks", music: "music-notes" }[c]}-duotone`],
  solarLine: (c) => ({ building: ["buildings-2-line-duotone"], home: ["home-2-line-duotone", "home-line-duotone"], briefcase: ["case-line-duotone"], wallet: ["wallet-line-duotone"], chart: ["chart-2-line-duotone"], folder: ["folder-line-duotone"], shield: ["shield-check-line-duotone"], heart: ["heart-line-duotone"], book: ["book-2-line-duotone", "book-line-duotone"], tool: ["settings-line-duotone", "wrench-line-duotone"], journal: ["notebook-bookmark-line-duotone", "notebook-line-duotone"], roster: ["checklist-line-duotone"], music: ["music-notes-line-duotone", "music-note-2-line-duotone"] }[c]),
  solarBold: (c) => ({ building: ["buildings-2-bold-duotone"], home: ["home-2-bold-duotone", "home-bold-duotone"], briefcase: ["case-bold-duotone"], wallet: ["wallet-bold-duotone"], chart: ["chart-2-bold-duotone"], folder: ["folder-bold-duotone"], shield: ["shield-check-bold-duotone"], heart: ["heart-bold-duotone"], book: ["book-2-bold-duotone", "book-bold-duotone"], tool: ["settings-bold-duotone", "wrench-bold-duotone"], journal: ["notebook-bookmark-bold-duotone", "notebook-bold-duotone"], roster: ["checklist-bold-duotone"], music: ["music-notes-bold-duotone", "music-note-2-bold-duotone"] }[c]),
  hugeicons: { building: ["building-03", "building-06"], home: ["home-01", "home-04"], briefcase: ["briefcase-01"], wallet: ["wallet-01", "wallet-02"], chart: ["analytics-01", "chart-histogram"], folder: ["folder-01"], shield: ["shield-01"], heart: ["favourite-square", "favourite"], book: ["book-01", "notebook-01"], tool: ["wrench-01", "tools"], journal: ["notebook-02", "notebook-01"], roster: ["check-list"], music: ["music-note-01", "music-note-02"] },
  streamlineColor: { building: ["building-2"], home: ["home-4", "home-3"], briefcase: ["briefcase-dollar", "briefcase"], wallet: ["wallet", "money-wallet"], chart: ["graph-bar-increase"], folder: ["folder-check", "folder-add"], shield: ["shield-check", "shield-1"], heart: ["heart", "love-it"], book: ["book-reading", "book-1", "read-1"], tool: ["tools-wench-screwdriver", "wench-1", "settings-slider"], journal: ["book-reading"], roster: ["task-list"], music: ["music-note-2", "music-note-1"] },
  fc: { building: ["org-unit", "home"], home: ["home"], briefcase: ["business", "portfolio"], wallet: ["money", "currency-exchange"], chart: ["bar-chart", "combo-chart"], folder: ["folder"], shield: ["security-checked", "privacy"], heart: ["like", "add-to-favorites"], book: ["reading", "library"], tool: ["engineering", "services", "support"], journal: ["reading-ebook", "address-book"], roster: ["todo-list"], music: ["music"] },
  fluentFlat: { building: ["office-building", "building-construction"], home: ["house", "house-with-garden"], briefcase: ["briefcase"], wallet: ["money-bag", "credit-card"], chart: ["bar-chart", "chart-increasing"], folder: ["file-folder", "open-file-folder"], shield: ["shield"], heart: ["red-heart", "sparkling-heart"], book: ["open-book", "books", "book"], tool: ["hammer-and-wrench", "wrench", "toolbox"], journal: ["notebook-with-decorative-cover"], roster: ["clipboard"], music: ["musical-notes", "musical-note"] },
...
const TREE_CAND = {
  ...
  "material-symbols": { grid: ["grid-view"], list: ["list"], history: ["history"], database: ["database"], "stock-quote": ["trending-up"], chart: ["bar-chart"], upload: ["upload"], sliders: ["tune"], gear: ["settings"], classroom: ["co-present"], users: ["group"], newspaper: ["newspaper"], plus: ["add"], quote: ["format-quote"], window: ["web-asset"], palette: ["palette"], info: ["info"], shapes: ["shapes"], note: ["sticky-note-2"], clip: ["attach-file"], shield: ["shield"] },
  ...
  "fluent-flat": { grid: ["card-index-dividers"], list: ["clipboard"], history: ["watch", "stopwatch"], database: ["file-cabinet", "card-file-box"], "stock-quote": ["chart-increasing"], chart: ["bar-chart"], upload: ["outbox-tray"], sliders: ["control-knobs"], gear: ["gear"], classroom: ["teacher"], users: ["busts-in-silhouette"], newspaper: ["newspaper"], plus: ["plus"], quote: ["left-speech-bubble"], window: ["window"], palette: ["artist-palette"], info: ["information"], shapes: ["puzzle-piece"], note: ["memo"], clip: ["paperclip"], shield: ["shield"] },
