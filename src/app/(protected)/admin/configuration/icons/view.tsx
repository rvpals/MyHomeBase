...
import { IconSlotsView } from "./slots-view";
...
export function IconsView({
  ...
  /** The icon set currently live — not the shell's draft pick. */
  savedSetId: string;
  savedSetName: string;
  slotGroups: { group: string; slots: IconSlot[] }[];
  ...
  const hasUnsavedSetChange = iconSetId !== savedSetId;
