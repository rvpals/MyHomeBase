...
export default async function Home({
  ...
  // This reader's stored preferences — read for the startup redirect below. They used
  // to feed the Clock card's forecast as well, which is why this sits above the
  // redirect; it is now the only consumer on this page.
  ...
  // The Clock card was retired from the home screen; the weather it used to carry now
  // belongs to the Floating Clock, which fetches its own forecast in the protected
  // layout. So this page makes **no outbound call at all** any more -- it used to be
  // the home screen's only one.
