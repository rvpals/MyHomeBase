...
export function ModuleCard({
  ...
  return (
    <Link
      href={href}
      className={`group relative block rounded-xl border border-line bg-paper-raised p-5 pt-6 transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-ink/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-2 focus-visible:ring-offset-paper motion-reduce:transition-none motion-reduce:hover:translate-y-0 ${className}`}
    >
