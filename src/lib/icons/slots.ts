...
export const ICON_SLOTS: IconSlot[] = [
  ...
  /* The five cards of the ticker viewer's Market tab — everything the provider said,
     ...
     tell these apart from the Own/Yahoo cards, which are deliberately unbadged. */
  {
  ...
  },
  {
    ...
    group: "Journal sections",
    where: "Journal → section panel → Data Management.",
    defaultConcept: "upload",
    wired: true,
    namespace: "tree",
  },
  ...
  {
    id: "journal_card_duplicates",
    label: "Duplicates card",
    group: "Journal cards",
    where: "Journal → Data Management → Correct → the Duplicates card header.",
    defaultConcept: "list",
    wired: true,
    namespace: "tree",
  },
  {
    id: "journal_card_recycled_entries",
    label: "Recycled Entries card",
    group: "Journal cards",
